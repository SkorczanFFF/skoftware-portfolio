...
export default function BottomBar() {
  ...
  return (
    <div className='gradient flex w-full items-center justify-between px-2 py-1 max-xsm:flex-col max-xsm:items-start max-xsm:gap-1'>
      <p className='text-[10px] uppercase tracking-widest text-white/90'>
        {t.footerCopyright.replace('{year}', String(CURRENT_YEAR))}
      </p>
      <Link
        href='/cookies'
        className='flex items-center gap-1.5 text-[10px] uppercase tracking-widest text-white/90 transition-colors duration-200 hover:text-white max-xsm:self-end'
      >
